...
export const SettingsSchema = z.object({
  ...
  context: z.object({
    ...
    maxPromptTokens: z.number().default(180000),
    systemOverheadEstimate: z.number().default(346),
    responseBufferTokens: z.number().default(4000),
    ...
    systemOverheadEstimate: 346,
    responseBufferTokens: 4000,
